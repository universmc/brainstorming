...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "très bien nous allons donc commencer par la page d'accueil avec un carrousel bootstrap avec des images [carrousel] bootstrap avec des images sur le theme Sur Art topiaire un art Dédié à la structure avec des végétaux `$(art_topiaire image =  (https://picsum.photos/seed/picsum/xxxx/xxxx)"
            }, 
