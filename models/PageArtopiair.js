...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "assistant",
                content: "très bien nous allons donc commencer par la page d'accueil avec un navBar+carrousel+card+footer bootstrap avec des images sur le theme de art_topiare un art dédier à la structure avec des végétaux index.html"
            }, 
        ...
        const outputFilePath = "build/Artopiare_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";
