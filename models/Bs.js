...
async function main() {
    ...
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "system",
                content: "Génère le code HTML/CSS/JS d'une page index.html blackTheme avec des component bootstrap"
            },
            {
                role: "assistant",
                content: "[RUN]bootstrap{components(names=[exemple]) pour /build Web page.html}"
            }, 
        ...
        const outputFilePath = "build/Bs_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";
